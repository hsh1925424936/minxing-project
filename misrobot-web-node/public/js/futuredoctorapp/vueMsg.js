Vue.component("headerbox",{
    template:"<div><p>{{ thistitle }}</p></div>",
    props:["thistitle"]
});
Vue.component("footertab",{
    ...
    methods:{
        toTodo:function(){
            return 'todo.html?todonum='+this.todonum+'&&msgnum='+this.msgnum;
        },
        toMsg:function(){
            return 'msg.html?todonum='+this.todonum+'&&msgnum='+this.msgnum;
        },
        toapp:function(){
            return 'application.html?todonum='+this.todonum+'&&msgnum='+this.msgnum;
        },
        tomy:function(){
            return 'my.html?todonum='+this.todonum+'&&msgnum='+this.msgnum;
        },
    }
});
