	...
	<div>
        <div>
            <el-breadcrumb separator=">">
              <el-breadcrumb-item :to="{ path: '/examManage/exam_test' } ">考试&试卷</el-breadcrumb-item>
            ...
            <el-tabs v-model="activeName">
                <el-tab-pane label="考试信息" name="first">
                    <div class = "exam-ope-title">
                        ...
                        <span class="exam-ope-title-item">考试状态：{{statusinfo | statusfn}}</span>
                ...
                <el-tab-pane v-if="creator == uid" label="考试总成绩" name="third">
                    ...
                    style="width: 100%">
                        ...
                        <el-table-column label="各技能项成绩">
                            <el-table-column v-for = "item in questionlist" :prop = "item.learnname" :label = "item.learnname"></el-table-column>
                        </el-table-column>
                    </el-table>
                </el-tab-pane>
                    ...
                    style="width: 100%">
                        ...
                        <el-table-column
                          ...
                          <template scope = "scope">
                              ...
                              <span v-if="scope.row.status==1">待评分</span>
                              <span v-if="scope.row.status==2">已评分</span>
                          </template>
                        </el-table-column>
                        <el-table-column
                          property="answertime"
                        ...
                        <el-table-column label="操作">
                          <template scope="scope">
                            <el-button type="text" v-if="scope.row.status==2" @click="toRateOperate(scope.$index, scope.row)">查看</el-button>
                            <el-button type="text" v-if="scope.row.status==1&&scope.row.teacherid==uid" @click="toRateOperate(scope.$index, scope.row)">评分</el-button>
                           </template>
                        </el-table-column>
                    </el-table>
                    <el-pagination
            ...
            getExamInfo(){
                ...
                post('/unifyexam/queryexamdetail',{
                    ...
                    if(data&&data.errcode==0){
                        ...
                        self.starttime = data.starttime&&data.endtime&&data.starttime.substr(0,19)+'~'+data.endtime.substr(11,19);
                        self.statusinfo=data.status;
                ...
                post('/unifyexam/querystuoperatscore',{
                    ...
                    if(data&&data.errcode==0){
                        ...
                        if(data.scorelist.length>0){
                            self.questionlist = data.scorelist[0].learnscorelist.map(item=>{
