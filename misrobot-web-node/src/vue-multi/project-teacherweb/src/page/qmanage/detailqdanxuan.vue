  ...
  <div>
    <ul class="qdetaillist">
      <li>
        ...
        <li v-show="picturelist.length!=0">
      ...
      <li>
        <span class="xlabel">选项：</span>
        <div class="xcontent">
          <ul>
            <li v-for="value in questionitem">
              <span class="xsublabel">{{value.itemname}}.</span>
              <span class="xcontent">{{value.content}}</span>
            </li>
          </ul>
        </div>
      </li>
