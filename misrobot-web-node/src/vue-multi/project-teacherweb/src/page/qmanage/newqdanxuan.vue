<template>
  <div class="container">
    ...
    <cmain :title="'正确答案'">
      <div class="maincontent">
        <el-radio v-for="(value,index) in options" class="radio" v-model="answer" :label="index | numtoa">{{ index | numtoa }}</el-radio>
      </div>
    </cmain>
    <cmain :title="'设置'">
      <div class="maincontent">
      ...
      filters:{
        ...
        methods: {
          ...
          deleteoption(index){//删除选项
            ...
            if( this.answer == this.numtoaArr[index] ){
              this.answer = '';
            }
