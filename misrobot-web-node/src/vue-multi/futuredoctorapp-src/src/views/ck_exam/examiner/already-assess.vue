<template>
    <div>
        <div class="test">
            <ul v-for="item in items" @click="toresult(item)">
            ...
            toresult(prama){
                ...
                this.post('/ckevaluation/queryevaluationinfo', {
                    ...
                    if(data.evaluations[0].type==2){
                        _this.$router.push({
                            name:'fdgradeover',query:{examinfo:prama,from:'index'}
                        });
                    }else {
                        _this.$router.push({
                            name:'fdgradeover2',query:{examinfo:prama,from:'index'}
                        });
                    }
                });
            }
...
<style lang="scss" scoped>
    ...
    .test>ul:after {
        ...
        width:1.1rem;
        height:1.1rem;
        background: url("../../../assets/images/tips_ypj.png") 0 0 no-repeat;
