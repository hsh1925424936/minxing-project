<template>
	<div class="g-wrapper signdetail">
		...
		<div class="booking-lab-sel g-main" style="margin-bottom: 2rem;">
			<div class="list lab-list ">
				...
				<template>
					...
					<a class="item valign-center" v-if="signedDetailList.status=='待审核'||signedDetailList.status=='待缴费'">
						<i class="iconfont icon-clock"></i>
						<button type="button" class="btn btn-yellow" @click="remove($event)" :removeid="detailId">取消报名</button>
					</a>
				</template>
		...
		<div  class="padding" style="padding: 0;" v-show="removePicture">
				<a href="http://139.196.6.204:8090/misrobot-edms/chksys/" >
					<img src="../../assets/images/广告.png" style="width: 100%;position: fixed;bottom: 0;z-index: 999;" id="advert" />
				</a>
				<img src="../../assets/images/btn_closed.png" id="deleteBtn" @click="deleteBtn" style="z-index: 9999 !important;"/>
	    </div>
		<c-modal :config="trainModal">
			<p style="padding: .2rem 10%;">请填写取消原因</p>
			<p style="margin-bottom: .2rem;">
				<textarea class="advice" v-model="removeText" style="resize: none;"></textarea>
			</p>
