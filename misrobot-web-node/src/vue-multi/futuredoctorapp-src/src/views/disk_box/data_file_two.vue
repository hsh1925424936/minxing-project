<template>
    <div class="g-wrapper">
        ...
        <div class="g-main">     
           <div class="list flex" v-for="(item,index) in shareFileList[shareFileList.length-1]" @click="enterDetail(item)"> 
        ...
        <!-- <div class="footer flex-between">
            ...
            <div v-show="showIframe" class="iframe">
             <c-header>
            <div slot="headerLeft">
       ...
       <transition name="fade">
            <div v-show="showVideo" class="videoAlert">
                <!-- <video controls>
                    <source :src="videoUrl" type="video/mp4">
                </video> -->
                    <video :src="videoUrl" muted="true" loop autoplay controls="controls">
                    </video>
            </div>
       </transition>
        <!--音频  -->
        <transition name="fade">
            <div v-show="showAudio" class="audioAlert">
        ...
        <!--图片  -->
        <transition name="fade">
            <div v-show="showPicture" class="pictureAlert">
        ...
        methods:{
            ...
            init(){
                this.post('/courseware/search',{
                    ...
                    status:1,
                    file_class:'',
                    key_word:this.searchName,
                    parent_id:this.parent_id,
                }).done((data)=>{
                    if(data && data.errcode == 0){
                        this.shareFileList.push(data.list)
                        console.log(this.shareFileList.length)
