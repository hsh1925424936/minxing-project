<template>
    <div>
        <div class="xiecontentBox" v-for="(value,index) in failedList" style="padding-bottom:.20rem">
            <dl>
                <dd>
                ...
                <dd>
                    ...
                    <b>
                        <i v-for="(value2,index2) in failedList[index].learnlist">{{ value2.learnname }}&nbsp;&nbsp;</i>
                    </b>
                </dd>
                <dd>
