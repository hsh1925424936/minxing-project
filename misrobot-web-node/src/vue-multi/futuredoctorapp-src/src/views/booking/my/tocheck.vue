        ...
        <div class="xiecontentBox" v-for="(value,index) in toCheckList">
            <dl>
                ...
                <dd>
                    ...
                    <b>
                        <i v-for="(value2,index2) in toCheckList[index].learnlist">{{ value2.learnname }}&nbsp;&nbsp;</i>
                    </b>
                </dd>
                <dd>
            ...
            <p class="xiebottomHandlers">
                ...
                <router-link :to="{name: 'fdCreateUpdateAppoint',query:{ apply:value }}" class="xiebtn xiebtn-default">修改</router-link>
            </p>
        </div>
