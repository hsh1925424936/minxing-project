  ...
  <div class="parent" id="parent">
    ...
    <div class="shop_cart">
      <p>
        ...
        <img id="end" src="../assets/logo.png" class="ver">
      </p>
      <!-- <span>￥0元起送</span> -->
    </div>
...
export default {
  ...
  data() {
    return {
      data: [
        {title:'珍珍',content:[{title:'海鲜',price:100}]}
      ],
...
.child2_box::-webkit-scrollbar {
  width: 0;
  height: 0;
}

.child1_box::-webkit-scrollbar {
  width: 0;
  height: 0;
}
.shop_snapshot_box {
...
.shop_cart>span {
  ...
  position: absolute;
  color: #b0b0b1;
  background-color: rgba(83, 83, 86, 0.8)
}
